...
import com.example.taquio.trasearch.Samok.Friends;
 ...
 */
public class BusFriendsFragment extends Fragment {
    private RecyclerView mFriendList;
    private FirebaseAuth mAuth;
    private DatabaseReference mFriendsDatabase
            ,mUsersDatabase;
    private static final String TAG = "BusFriendsFragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,@NonNull ViewGroup container,
        ...
        mMainView = inflater
                .inflate(R.layout.business_fragment_friendslist,container,false);
