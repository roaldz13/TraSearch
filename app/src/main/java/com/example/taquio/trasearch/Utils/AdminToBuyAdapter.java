...
public class AdminToBuyAdapter extends RecyclerView.Adapter<AdminToBuyAdapter.ViewHolder>{

    private static final String TAG = "Enter BUy Adapter" ;
    private List<ToBuy> mybuyMaterials;
    private Context mcontext;

    public AdminToBuyAdapter(ArrayList<ToBuy> tobuyList, AdminJunkShopView adminJunkShopView) {
