...
public class BusChatAdapter extends RecyclerView.Adapter<BusChatAdapter.ChatViewHolder>{
    ...
    public BusChatAdapter(List<Chats> mMessageList) {
    ...
    public ChatViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.buschat_single_layout ,parent, false);
    ...
    public void onBindViewHolder(final ChatViewHolder holder, int position) {
        ...
        Log.d(TAG, "testfrom_user: " + from_user);
