...
import com.example.taquio.trasearch.BusinessProfile.BusinessSellFragment;
...
public class ToSellAdapter2 extends RecyclerView.Adapter<ToSellAdapter2.ViewHolder>{

    private static final String TAG = "Enter Sell Adapter" ;
    private List<ToSell> mysellMaterials;
    private Context mcontext;

    public ToSellAdapter2(ArrayList<ToSell> tosellList, Context context) {
